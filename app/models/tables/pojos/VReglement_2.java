...
public class VReglement_2 implements Serializable {

    private static final long serialVersionUID = 1098847675;
    ...
    public VReglement_2(VReglement_2 value) {
        this.id = value.id;
        ...
        this.anneeReel = value.anneeReel;
    ...
    public String getAnneeReel() {
        return this.anneeReel;
    }

    public void setAnneeReel(String anneeReel) {
        this.anneeReel = anneeReel;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VReglement_2 (");
